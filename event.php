...
<div id="wrapper">
    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <!-- Icon Cards-->
            <div class="form">
                <h2 class="col-form-label">Create an Event!</h2>
                <form class="text-a" name="createEvent" method="post" action="createEvent.php">
                    <label class="col-form-label-sm" for="title">Event Title:</label><br>
                    <Input type="text" placeholder="Enter Event Title" name="title" class="inputbox"><br>
                    <label class="col-form-label-sm" for="date">Event date:</label><br>
                    <input type="date" value="2019-04-30"  name="date" class="inputbox"><br>
                    <label class="col-form-label-sm" for="description">Description: </label><br>
                    <input type="text" placeholder="Enter Description" name="description" class="inputbox"><br>
                    <label class="col-form-label-sm" for="location">Location : </label><br>
                    <input type="text" placeholder="Enter location" name="location" class="inputbox"><br><br>
                    <label class="col-form-label-sm" for="attendees">Limit attendees?: </label><br>
                    <input type="text" placeholder="Enter attendees" name="attendees" class="inputbox"><br><br>
                    <label class="col-form-label-sm" for="gender">Gender restricted? </label><br>
                    <select class="col-form-label-sm" name="genderName">
                    ...
                    <select class="col-form-label-sm" name="sportName">
                        <?php
                    ...
                    <button type="submit" value="createEvent" name="eventButton" class="btn-success">Create Event</button><br>
                </form>
            </div>
            <!-- /.container-fluid -->
